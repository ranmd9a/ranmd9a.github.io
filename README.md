...
| [beatleader-ranked](https://github.com/ranmd9a/beatleader-ranked/releases/latest) | **[BeatLeader](https://www.beatleader.xyz/leaderboards)のランク譜面を星別にプレイリスト化したもの。**<br>BeatLeaderプラグインを入れたらランク譜面丸ごとダウンロードできますが、単一のプレイリストになって探しづらいので作成したものです。<br>毎日、日本時間午前1:00頃に更新しています。<br>※たまに更新に失敗しますが基本的には rank への追加は毎週金曜のようなので土曜 1:00 の失敗以外はあまり影響ないはず。 |
